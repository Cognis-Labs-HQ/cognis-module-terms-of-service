...
Modul mendaftarkan rute SPA publik `/terms-of-service`, `/privacy-policy`, dan `/eula`. Administrasi menerima satu bagian Legal yang dilokalkan melalui `registerAdminSection`; rute API terautentikasi meminta peran dengan hak paling rendah yang sesuai.
